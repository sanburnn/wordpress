...
= 1.4.8 =
* Search issue fixed with hide title.
...
= 1.4.3 =
* Fixed little coding bugs.
* Improved UI for better user experience.
* Tasted with WordPress version 6.0.2

= 1.4.2 =
* Fixed Security issues.
* Tasted with WordPress version 6.0.1

= 1.4.1 =
* Added js for fresh load images.
* Tasted with WordPress version 6.0

= 1.4.0 =
* Filter background color is now changeable with custom css.
* Tasted with WordPress version 5.9.3

= 1.3.9 =
* Removed Extra Slashes from filters.
* Tasted with WordPress version 5.9.3

= 1.3.8 =
* Errors Fixed.
* Tasted with WordPress version 5.9

= 1.3.7 =
* Translation Bug Fixed.
* Tasted with WordPress version 5.8.3

= 1.3.6 =
* Additional changes: Spanish translation ready.
* Tasted with WordPress version 5.8.2
...
= 1.3.3 =
* Added exclude wordpress lazy load fuction.
* Tested on wordpress 5.8.
* changes filter sort alphabatical order.
...
= 1.3.0 =
* Tasted with WordPress version 5.7.2
* Fixed minor bugs.

= 1.2.9 =
* Added LD Lightbox option to show filtred images group
* Fixed image transition issue.

= 1.2.8 =
* Tasted with WordPress version 5.6.1
* Fixed lightbox arrow issue.

= 1.2.7 =
* Transition issue fixed
* Column ct off issue fixed
...
* Bootstrap lightbox issue fixed.
* New Lightbox option added.

= 1.1.5 =
* Filter Delete, Edit Bug Fixed
* Typo Error Fixed

= 1.1.4 =
* Fix nonce issue
* Fix Bootstrap Lightbox Alignment issue

= 1.1.3 =
* Security Fix: Ajax Nonce nonce implemented to delete filter(s)

= 1.1.2 =
* Hover effect issue fixed
* Hide filters / category option added
* Bug fixed

= 1.1.1 =
* Sanitization added
* Escaping added
* Nonce field added on form and verified while posting data
* Bad coding techniques removed (like Serialize / Base64Encode function removed)
* 1.07 to 1.0.9 settings update button added
...
= 1.0.0 =
* Completely Change of dashboard interface
