...
https://www.youtube.com/watch?v=sBvZR7P8Ml0
...
1. Search for Brave Builder through 'Plugins > Add New' interface.
2. Find the plugin box of Brave Builder  and click on the 'Install Now' button.
3. Then activate the Brave Builder plugin.
...
1. [Download Brave Builder](https://downloads.wordpress.org/plugin/brave-popup-builder.zip)
2. Upload the Brave Builder  through 'Plugins > Add New > Upload' interface or upload bravepopup-free folder to the '/wp-content/plugins/' directory.
3. Activate the Brave Builder  plugin through the 'Plugins' menu in WordPress.
4. Create a new Popup: After installing the plugin, a new menu called "Popups" will appear. Visit that page and click the + icon to Create New Popup.
...
* Fixed: PHP 5.6.4+ Compatiblity Issues.
...
= 0.4.6 - 15 Jun 2021. =
* Added: Scroll Trigger feature now has the ability to only show popups between certain percents of the page.
...
= 0.4.3 - 10 May 2021. =
* Added: Unlocked the PRO Frequency option.
...
* Fixed: Radio fields were not rendeing properly on mobile devices.
...
* Added: 6 hours, 12 hours and current Session option in Frequency Close Settings.
...
* Fixed: Click openning popups were not working on Microsoft Edge.
...
* Fixed: Radio Field was always sending the last value.
* Fixed: Popups wider than 320px were being cut off on old Iphones.
...
* Fixed: Close Button with text was being squeezed.
* Fixed: If a page is set as homepage, selecting the page to display the popup was not working.
* Fixed: Popup Goal change was not being reflected on "All Popups" page.
* Fixed: Products Element description length option was not being respected.
...
* Added: New Posts Element. Display our Latest Posts inside your Popup.
...
* Fixed: Removed Unncessary PRO option in Free edition to reduce confusion.
...
* Added: [Woocommerce] Products Element can now Latest Products.
...
* Added: Ability to Duplicate Popup.
